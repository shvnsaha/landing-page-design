...
const CompanyLogo = () => {
    ...
    return (
        <div className="bg-black overflow-hidden md:py-16 py-8 relative">
                        ...
                        <div className="flex shirk-0 min-w-full items-center justify-around px-4">
                           {
                            logoSet.map((logo,idx)=>(
                                <img key={idx} src={logo.src} alt={logo.alt} width={logo.width} height={logo.height}  className="mx-8 object-contain shrink-0"/>
                            ))
                           }
                        </div>
                    ))
